...
namespace DStream
{
    ...
    Hilbert3::Hilbert3(uint8_t quantization, uint8_t algoBits, std::vector<uint8_t> channelDistributions) : Coder(quantization, algoBits, channelDistributions)
	{
#ifdef _WIN32
	...
	Color Hilbert3::EncodeValue(uint16_t val)
	{
    ...
    uint16_t Hilbert3::DecodeValue(Color col1)
    {
    ...
    void Hilbert3::TransposeFromHilbertCoords(Color& col)
    {
    ...
    void Hilbert3::TransposeToHilbertCoords(Color& col)
    {
        int X[3] = { col.x, col.y, col.z };
